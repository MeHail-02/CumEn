...
const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Облицовка стен вертикальными слэбами с подбором рисунка прожилок.',
...
const workflowSteps = [
  {
    ...
    desc: 'Наш инженер приезжает на ваш объект с чемоданом образцов камня. Мы проводим лазерное 3D-сканирование основы под изделие, что исключает зазоры при установке.'
  },
  {
    num: '02',
    title: 'Проектирование & 3D-раскладка',
    desc: 'Мы создаем 3D-модель вашего изделия. Специально согласовываем раскладку слэбов (особенно рисунок вен в стыках по технологии Bookmatch) перед началом резки.'
  },
  {
    num: '03',
    title: 'Высокоточное производство',
    desc: 'Раскрой камня происходит на 5-осевых итальянских центрах ЧПУ с водяным охлаждением. Кромки, фаски и сложные радиусы доводятся мастерами вручную.'
  },
  {
    num: '04',
    title: 'Доставка & Монтаж под ключ',
    desc: 'Бережно доставляем изделия на пирамидах. Установка производится сертифицированной бригадой без пыли. Вы получаете официальную гарантию 5 лет.'
  }
];
    ...
    <div className="services-page fade-in">
      ...
      <section className="services-hero">
        ...
        <div className="container hero-content">
          <span className="hero-pre-title">Собственное производство</span>
          <h1 className="hero-main-title">
            От идеи до монтажа:<br />
            создаем интерьеры из камня
          </h1>
          <p className="hero-sub-text">
            AURA STONE предоставляет полный цикл камнеобработки. Мы берем на себя все заботы: от лазерного сканирования основы и составления спецификации до раскроя на ЧПУ-станках и финишной полировки швов на объекте.
          </p>
          ...
          <div className="conversion-wrapper">
            ...
            <div className="conversion-info-col">
              ...
              <p className="conv-desc">
                Есть готовый дизайн-проект, спецификация или набросок с размерами? Прикрепите файлы ниже. Наш инженер производства проанализирует чертежи и подготовит коммерческое предложение в течение 2 часов.
              </p>
              ...
              <div className="benefits-list">
                <div className="benefit-item">
                  ...
                  <div>
                    <h5>Бесплатный выезд на замер</h5>
                    <p>Привезем образцы камня прямо на объект и поможем подобрать цвет.</p>
                  </div>
                </div>
                ...
                <div className="benefit-item">
                  ...
                  <div>
                    <h5>Гарантийный сертификат</h5>
                    <p>Выдаем официальную гарантию 5 лет на все виды изделий и швы.</p>
                  </div>
                </div>
