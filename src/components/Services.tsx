...
const workflowSteps = [
  ...
  },
  {
    ...
    desc: 'Мы создаем 3D-модель вашего изделия. Специально согласовываем раскладку камней (особенно рисунок вен в стыках по технологии Bookmatch) перед началом резки.'
  },
  {
    num: '03',
