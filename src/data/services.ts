...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    description: 'Создание каминных порталов от классических резных до современных монолитных из цельных слэбов. Тщательный подбор рисунка прожилок камня. Интеграция с топками любого типа с соблюдением всех норм пожарной безопасности.',
  ...
  },
  {
    ...
    features: [
      'Собственный автопарк с пирамидами для слэбов',
...
export const portfolioData: PortfolioItem[] = [
  ...
  {
    id: 'p3',
    title: 'Ванная комната в едином слэбе Carrara White',
